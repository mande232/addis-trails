    ...
    checkpoints: [
      {
        ...
        instructionEn: "Start at Megenagna terminal. Walk toward the smell of berbere.",
        instructionAm: "ከመገናኛ መስቀለኛ መንገድ ተነስተህ ወደ በርበሬ ሽታ ሂድ።",
        distanceM: 0,
      },
      {
        order: 2,
        photo: img("photo-1518709268805-4e9042af2176", 1600, 2000),
        instructionEn: "Pass two rows of spice stalls. The crafts alley opens on your left.",
        instructionAm: "ሁለት ረድፍ የቅመም መሸጫዎችን አልፍ። የእጅ ስራ መተላለፊያ በግራህ ይከፈታል።",
        distanceM: 150,
      },
    ],
    reviews: [],
