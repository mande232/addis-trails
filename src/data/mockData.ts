    ...
    checkpoints: [
      {
        order: 1,
        photo: img("photo-1582540730843-c84c1f3eaaef", 1600, 2000),
        instructionEn: "From Piazza taxi stop, face uphill. The road tilts toward old stone buildings.",
        instructionAm: "ከፒያሳ ታክሲ ማቆሚያ ወደ ላይ ፊትህን አዙር። መንገዱ ወደ አሮጌዎቹ የድንጋይ ሕንፃዎች ይዘንባል።",
        distanceM: 0,
        nextLandmark: "Commercial Bank corner",
      },
      {
        order: 2,
        photo: img("photo-1571115764595-644a1f56a55c", 1600, 2000),
        instructionEn: "Pass the Commercial Bank on your right. Keep the jewelry shops on your left.",
        instructionAm: "በቀኝ በኩል ኮሜርሻል ባንክን አልፍ። የወርቅ ሱቆች በግራህ ይሁኑ።",
        distanceM: 160,
        nextLandmark: "Wooden colonial facade",
      },
      {
        order: 3,
        photo: img("photo-1566073771259-6a8506099945", 1600, 2000),
        instructionEn: "The wooden colonial facade of Taitu Hotel appears on your left. Enter under the green canopy.",
        instructionAm: "የጣይቱ ሆቴል የእንጨት የቅኝ ግዛት ፊት በግራህ ይታያል። በአረንጓዴው መጠለያ ስር ግባ።",
        distanceM: 300,
      },
    ],
    reviews: [],
